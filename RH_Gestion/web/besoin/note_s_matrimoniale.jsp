        ...
        <div class="card-body">
          <form>
            ...
            <div class="row critere-poste-line">
              <div class="col-lg-6">
                <input type="text" min="0" class="form-control input-formulaire" value="C�libataire" readonly>
              </div>
              <div class="col-lg-6">
            ...
            <div class="row critere-poste-line">
              <div class="col-lg-6">
                <input type="text" min="0" class="form-control input-formulaire" value="Mari�(e)" readonly>
              </div>
              <div class="col-lg-6">
                <input type="number" min="0" class="form-control input-formulaire">
              </div>
