...
CREATE view v_besoin_matrimoniale as (select s_matrimoniale.id_s_matrimo,s_matrimoniale.niveau,s_matrimoniale.designation,notation_s_mat.id_besoin,notation_s_mat.note from notation_s_mat join s_matrimoniale on s_matrimoniale.id_s_matrimo=notation_s_mat.id_s_matrimo);
